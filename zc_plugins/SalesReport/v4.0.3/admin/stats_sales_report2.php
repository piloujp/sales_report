...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
    ...
    <tr>
        <td class="text-center" colspan="2">
            <a href="<?= zen_href_link(FILENAME_STATS_SALES_REPORT2, zen_get_all_get_params(['output_format']) . 'output_format=none', 'NONSSL') ?>">
                <span class="pageHeading"><?= PAGE_HEADING ?></span>
            </a><br>
        </td>
    </tr>
    <tr>
        <td class="text-center" colspan="2">
            <a href="<?= zen_href_link(FILENAME_STATS_SALES_REPORT2, zen_get_all_get_params(['output_format']) . 'output_format=none', 'NONSSL') ?>">
                <span class="pageHeading"><?= $start_date . PRINT_DATE_TO . $end_date ?></span>
            </a><br>
        </td>
    </tr>
    <tr class="v-top">
...
?>
                <td class="smalltext"><?= $date_target_heading ?></td>
            </tr>
            <tr>
                <td class="smallText"><?= sprintf(PRINT_TIMEFRAMES, $timeframe_key[$timeframe], $timeframe_sort) ?></td>
            </tr>
            <tr>
                <td class="smalltext"><?= PRINT_DETAIL_LEVEL . $detail_key[$detail_level] ?></td>
            </tr>
        </table></td>
...
?>
            <tr>
                <td class="smalltext"><?= PRINT_PAYMENT_METHOD ?></td>
                <td class="smalltext"><?= $payment_key[$payment_method] ?></td>
            </tr>
<?php 
    }
...
?>
            <tr>
                <td class="smalltext"><?= PRINT_CURRENT_STATUS ?></td>
                <td class="smalltext"><?= sprintf(PRINT_ORDER_STATUS, $status_key[$current_status], $current_status) ?></td>
            </tr>
<?php 
}
?>
    ...
    <tr>
        <td colspan="2"><?= zen_black_line() ?></td>
    </tr>
<!-- END PRINT HEADER -->
<?php
...
<body>
    ...
    <?= zen_draw_form('search', FILENAME_STATS_SALES_REPORT2, '', 'get', '', true) .
    ...
    <table class="table">
        ...
        <tr>
            <td colspan="2">
                <fieldset><legend><?= HEADING_TITLE_SEARCH ?></legend>
                <table class="table">
                    <tr class="v-top">
                        <td><table id="tbl_date_preset">
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_DATE_PRESET ?></strong>&nbsp;
                                    <button id="choose-custom" type="button"><?= BUTTON_TIMEFRAME_CUSTOM ?></button>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="smallText" id="td_last_year">
                                    <?= zen_draw_radio_field('date_preset', 'last_year', ($date_preset === 'last_year')) . sprintf(SEARCH_DATE_LAST_YEAR, date('Y') - 1) ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText" id="td_last_12_months">
                                    <?= zen_draw_radio_field('date_preset', 'last_12_months', ($date_preset === 'last_12_months')) . SEARCH_DATE_LAST_12_MONTHS ?>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table id="tbl_date_custom">
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_DATE_CUSTOM ?></strong>&nbsp;
                                    <button id="choose-preset" type="button"><?= BUTTON_TIMEFRAME_PRESET ?></button>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText">
                        ...
                        <td><table>
                            <tr>
                                <td class="smallText"><strong><?= SEARCH_DATE_TARGET ?></strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="smallText" id="td_date_status">
                                    <?= zen_draw_pull_down_menu('date_status', $status_array, $date_status, 'id="date_status"') ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText">
                                    <?= zen_draw_checkbox_field('doProdInc', '1', $doProdInc, '', 'id="do-prod-inc"') . ' ' . SEARCH_SPECIFIC_PRODUCTS ?>
                                </td>
                            </tr>
                            <tr>
<?php
...
?>
                                <td class="smallText" id="td_prod_includes">
                                    <?= zen_draw_input_field('prod_includes', $temp_prods) ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText">
                                    <?= zen_draw_checkbox_field('doCustInc', '1', $doCustInc, '', 'id="do-cust-inc"') . ' ' . SEARCH_SPECIFIC_CUSTOMERS ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText" id="td_cust_includes">
                                    <?= zen_draw_input_field('cust_includes', $temp_cust);?>
                                </td>
                            </tr>
                        </table></td>
                        <td><table>
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_PAYMENT_METHOD ?></strong>
                                    <br>
                            ...
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_PAYMENT_METHOD_OMIT ?></strong>
                                    <br>
...
?>
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_CURRENT_STATUS ?></strong>
                                    <br>
                                    <?= zen_draw_pull_down_menu('current_status', array_merge($empty_select, $status_array), $current_status, 'id="current_status"') ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_EXCLUDED_STATUS ?></strong>
                                    <br>
                                    <?= zen_draw_pull_down_menu('excluded_status', array_merge($empty_select, $status_array), $excluded_status, 'id="excluded-status"') ?>
                                </td>
                            </tr>
<?php 
...
?>
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_MANUFACTURER ?></strong>
                                    <br>
...
?>
        ...
        <tr>
            <td colspan="2">
                <fieldset><legend><?= HEADING_TITLE_SORT ?></legend>
                <table class="table">
                    <tr class="v-top">
        <!-- nested table to show/hide sort options without shifting entire row-->
                        <td><table>
                            <tr>
                                <td class="smallText"><strong><?= SEARCH_TIMEFRAME ?></strong></td>
                            </tr>
                            <tr>
                                <td class="smallText"><?=
                        ...
                        <td><table>
                            <tr>
                                <td class="smallText"><strong><?= SEARCH_TIMEFRAME_SORT ?></strong></td>
                            </tr>
                            <tr>
                                <td class="smallText"><?=
                        ...
                        <td><table>
                            <tr>
                                <td class="smallText">
                                    <strong><?= SEARCH_DETAIL_LEVEL ?></strong>
                                    <br>
                                    <?= zen_draw_pull_down_menu('detail_level', $detail_array, $detail_level, 'id="detail_level"') ?>
                                </td>
                            </tr>
                        </table></td>
        <!-- end table nesting -->
                        <td><div id="div_li_table_a"><table>
                            <tr class="v-top">
                                <td class="smallText" id="li-sort-title-order">
                                    <strong><?= SEARCH_SORT_ORDER ?></strong>
                                </td>
                                <td class="smallText" id="li-sort-title-product">
                                    <strong><?= SEARCH_SORT_PRODUCT ?></strong>
                                </td>
                            </tr>
                            <tr class="v-top">
                                <td class="smallText">
                                    <?= zen_draw_pull_down_menu('li_sort_a', $order_sorts_array, $li_sort_a_order, 'id="li-sort-a-order"') .
                                               zen_draw_pull_down_menu('li_sort_a', $product_sorts_array, $li_sort_a_product, 'id="li-sort-a-product"') ?>
                                    <br>
                                    <?=
                                        zen_draw_radio_field('li_sort_order_a', 'asc', $li_sort_order_a === 'asc') . sales_report2::getUpArrowIcon() . RADIO_LI_SORT_ASC .
                                        '<br>' .
                                        zen_draw_radio_field('li_sort_order_a', 'desc', $li_sort_order_a !== 'asc') . sales_report2::getDownArrowIcon() . RADIO_LI_SORT_DESC;
                                    ?>
                                 </td>
                                 <td>
                                 </td>
                        ...
                        <td><div id="div_li_table_b"><table>
                            <tr>
                                <td class="smallText"><strong><?= SEARCH_SORT_THEN ?></strong></td>
                            </tr>
                            <tr>
                                <td class="smallText">
                                    <?= zen_draw_pull_down_menu('li_sort_b', $order_sorts_array, $li_sort_b_order, 'id="li-sort-b-order"') .
                                        zen_draw_pull_down_menu('li_sort_b', $product_sorts_array, $li_sort_b_product, 'id="li-sort-b-product"') ?>
                                    <br>
                                    <?=
                                    zen_draw_radio_field('li_sort_order_b', 'asc', $li_sort_order_b === 'asc') . sales_report2::getUpArrowIcon() . RADIO_LI_SORT_ASC . '<br>' .
                                    zen_draw_radio_field('li_sort_order_b', 'desc', $li_sort_order_b !== 'asc') . sales_report2::getDownArrowIcon() . RADIO_LI_SORT_DESC ?>
                                </td>
                            </tr>
                        </table></div></td>
                    </tr>
        ...
        <tr>
            <td colspan="2">
                <fieldset><legend><?= HEADING_TITLE_PROCESS ?></legend>
                <table class="table">
                    <tr class="v-bot">
                        <td class="smallText">
                            <strong><?= SEARCH_OUTPUT_FORMAT ?></strong>
                            <br>
                            <?= zen_draw_pull_down_menu('output_format', $output_array, $output_format, 'id="output-format"') ?>
                        </td>
                        <td class="smallText">
                            <?= zen_draw_separator('pixel_trans.gif', 175, 1) ?>
                            <br>
                            <span id="span-auto-print"><?= zen_draw_checkbox_field('auto_print', '1', false) . CHECKBOX_AUTO_PRINT ?></span>
                            <span id="span-csv-header"><?= zen_draw_checkbox_field('csv_header', '1', false) . CHECKBOX_CSV_HEADER ?></span>
                        </td>
                        <td class="smallText" id="order-total-validation">
                            <?= zen_draw_checkbox_field('order_total_validation', '1', $order_total_validation) . CHECKBOX_VALIDATE_TOTALS ?>
                            <br>
                            <?= zen_draw_checkbox_field('display_email', '1', $display_email_address, '', 'id="display-email-address"') . CHECKBOX_DISPLAY_EMAIL_ADDRESS ?>
                        </td>
                        <td class="smallText text-right">
                            <?= zen_draw_checkbox_field('new_window', '1', $new_window, '', 'id="new-window"') . CHECKBOX_NEW_WINDOW ?>
                            <br>
                            <button type="button" id="btn-submit"><?= BUTTON_SEARCH ?></button>
                        </td>
                    </tr>
                </table></fieldset>
            </td>
        ...
        <tr class="v-top">
            <td><?= zen_draw_separator('pixel_trans.gif', 1, 15) ?></td>
            <td id="td_wait_text" class="alert text-right"><?= SEARCH_WAIT_TEXT ?>&nbsp;&nbsp;</td>
        </tr>
<?php 
...
?>
            <td class="text-right"<?= $colspan ?>>
                <a href="<?= $sr_link ?>" title="<?= TEXT_PRINT_FORMAT_TITLE ?>">
                    <span class="smallText"><?= $icon_print . TEXT_PRINT_FORMAT ?></span>
                </a>
            </td>
        </tr>
<?php
...
?>
      <!--TIMEFRAME TOTAL HEADER-->
                <tr class="totalHeadingRow">
                    ...
                    <td class="totalHeadingContent text-center" colspan="2"><?= TABLE_HEADING_NUM_PRODUCTS ?></td>
                    <td class="totalHeadingContent text-right"><?= TABLE_HEADING_TOTAL_GOODS ?></td>
<?php 
        if ($display_tax === true) {
?>
                    <td class="totalHeadingContent text-right"><?= TABLE_HEADING_GOODS_TAX ?></td>
                    <td class="totalHeadingContent text-right"><?= TABLE_HEADING_ORDER_RECORDED_TAX ?></td>
<?php 
        }
?>
                    <td class="totalHeadingContent text-right"><?= TABLE_HEADING_SHIPPING ?></td>
                    <td class="totalHeadingContent text-center" colspan="2"><?= TABLE_HEADING_DISCOUNTS ?></td>
                    <td class="totalHeadingContent text-center" colspan="2"><?= TABLE_HEADING_GC_SOLD ?></td>
                    <td class="totalHeadingContent text-center" colspan="2"><?= TABLE_HEADING_GC_USED ?></td>
                    <td class="totalHeadingContent text-right"><?= TABLE_HEADING_TOTAL ?></td>
                </tr>
<?php
    }
...
?>
                    ...
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['goods']) ?></td>
<?php 
            if ($display_tax) {
?>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['goods_tax']) ?></td>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['order_recorded_tax']) ?></td>
<?php 
            }
?>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['shipping']) ?></td>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['discount']) ?></td>
                    <td class="totalContent no-wrap"><?= TEXT_QTY . $timeframe['total']['discount_qty'] ?></td>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['gc_sold']) ?></td>
                    <td class="totalContent no-wrap"><?= TEXT_QTY . $timeframe['total']['gc_sold_qty'] ?></td>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['gc_used']) ?></td>
                    <td class="totalContent no-wrap"><?= TEXT_QTY . $timeframe['total']['gc_used_qty'] ?></td>
                    <td class="totalContent text-right"><?= $currencies->format($timeframe['total']['grand']) ?></td>
<?php 
            if ($sr->detail_level === 'order' && $order_total_validation === true) {
?>
...
?>
                <tr class="totalRow">
                    <td class="totalContent"><?= $time_display ?></td>
                    <td class="totalContent text-center" colspan="<?= $colspan ?>"><?= TEXT_NO_DATA ?></td>
                </tr>
<?php
        }
      ...
      <!--ORDER LINE ITEM HEADER-->
                <tr class="lineItemHeadingRow">
                    <td class="lineItemHeadingContent text-center">
                        <?= TABLE_HEADING_ORDERS_ID . show_arrow('oID') ?>
                    </td>
                    <td class="lineItemHeadingContent">
                        <?= TABLE_HEADING_CUSTOMER . show_arrow('last_name') ?>
                    </td>
<?php
            if ($display_email_address === true) {
?>
                    <td class="lineItemHeadingContent">
                        <?= TABLE_HEADING_EMAIL_ADDRESS . show_arrow('email') ?>
                    </td>
<?php
            }
            if ($show_country_and_state === true) {
?>
                    <td class="lineItemHeadingContent">
                        <?= TABLE_HEADING_COUNTRY . show_arrow('country') ?>
                    </td>
                    <td class="lineItemHeadingContent">
                        <?= TABLE_HEADING_STATE . show_arrow('state') ?>
                    </td>
<?php
            }
?>
                    <td class="lineItemHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_NUM_PRODUCTS . show_arrow('num_products') ?>
                    </td>
                    <td class="lineItemHeadingContent text-right">
                        <?= TABLE_HEADING_TOTAL_GOODS . show_arrow('goods') ?>
                    </td>
<?php 
            if ($display_tax === true) {
?>
                    <td class="lineItemHeadingContent text-right">
                        <?= TABLE_HEADING_GOODS_TAX ?>
                    </td>
                    <td class="lineItemHeadingContent text-right">
                        <?= TABLE_HEADING_ORDER_RECORDED_TAX ?>
                    </td>
<?php 
            }
?>
                    <td class="lineItemHeadingContent text-right">
                        <?= TABLE_HEADING_SHIPPING . show_arrow('shipping') ?>
                    </td>
                    <td class="lineItemHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_DISCOUNTS . show_arrow('discount') ?>
                    </td>
                    <td class="lineItemHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_GC_SOLD . show_arrow('gc_sold') ?>
                    </td>
                    <td class="lineItemHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_GC_USED . show_arrow('gc_used') ?>
                    </td>
                    <td class="lineItemHeadingContent text-right">
                        <?= TABLE_HEADING_ORDER_TOTAL . show_arrow('grand') ?>
                    </td>
<?php 
            if ($order_total_validation === true) {
?>
                    <td class="lineItemHeadingContent ValidationColumnHeader text-right">
                        <?= TABLE_HEADING_ORDER_TOTAL_VALIDATION ?>
                    </td>
<?php 
            }
?>
...
?>
                <tr class="lineItemRow">
                    <td class="lineItemContent text-center">
                        <strong>
                            <a href="<?= zen_href_link(FILENAME_ORDERS, 'oID=' . $o_data['oID'] . '&action=edit') ?>">
                                <?= $o_data['oID'] ?>
                            </a>
                        </strong>
                    </td>
                    <td class="lineItemContent">
                        <?= $o_data['last_name'] . ', ' . $o_data['first_name'] ?>
                    </td>
<?php
                if ($display_email_address === true) {
?>
...
?>
                    ...
                    <td class="lineItemContent no-wrap">
                        <?= (count($o_data['diff_products']) > 1 ? TEXT_DIFF . count($o_data['diff_products']) : ($o_data['num_products'] > 1 ? TEXT_SAME : TEXT_SAME_ONE)) ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['goods']) ?>
                    </td>
<?php 
                if ($display_tax === true) {
?>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['goods_tax']) ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['order_recorded_tax']) ?>
                    </td>
<?php 
                }
?>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['shipping']) ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['discount']) ?>
                    </td>
                    <td class="lineItemContent no-wrap">
                        <?= TEXT_QTY . $o_data['discount_qty'] ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['gc_sold']) ?>
                    </td>
                    <td class="lineItemContent no-wrap">
                        <?= TEXT_QTY . $o_data['gc_sold_qty'] ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['gc_used']) ?>
                    </td>
                    <td class="lineItemContent no-wrap">
                        <?= TEXT_QTY . $o_data['gc_used_qty'] ?>
                    </td>
                    <td class="lineItemContent text-right">
                        <?= $currencies->format($o_data['grand']) ?>
                    </td>
<?php 
                if ($order_total_validation === true) {
?>
                    <td class="lineItemContent ValidationColumnContent text-right">
                        <?= $o_data['order_total_validation'] ?>
                    </td>
<?php 
                }
?>
...
?>
                <tr class="lineItemHeadingRow">
                    <td colspan="<?= $colspan ?>"><table class="table">
      <!--PRODUCT LINE ITEM HEADER -->
                        <tr class="lineItemHeadingRow">
                            <td class="lineItemHeadingContent">
                                <?= TABLE_HEADING_PRODUCT_ID . show_arrow('pID') ?>
                            </td>
                            <td class="lineItemHeadingContent">
                                <?= TABLE_HEADING_PRODUCT_NAME . show_arrow('name') ?>
                            </td>
                            <td class="lineItemHeadingContent">
                                <?= TABLE_HEADING_PRODUCT_ATTRIBUTES . show_arrow('attributes') ?>
                            </td>
<?php 
            if (DISPLAY_MANUFACTURER) {
?>
                            <td class="lineItemHeadingContent">
                                <?= TABLE_HEADING_MANUFACTURER . show_arrow('manufacturer') ?>
                            </td>
<?php 
            }
?>
                            <td class="lineItemHeadingContent">
                                <?= TABLE_HEADING_MODEL . show_arrow('model') ?>
                            </td>
                            <td class="lineItemHeadingContent text-right">
                                <?= TABLE_HEADING_BASE_PRICE . show_arrow('base_price') ?>
                            </td>
                            <td class="lineItemHeadingContent text-right">
                                <?= TABLE_HEADING_FINAL_PRICE . show_arrow('final_price') ?>
                            </td>
                            <td class="lineItemHeadingContent text-right">
                                <?= TABLE_HEADING_QUANTITY . show_arrow('quantity') ?>
                            </td>
<?php 
            if ($display_tax === true) {
?>
...
?>
                            <td class="lineItemHeadingContent text-right">
                                <?= TABLE_HEADING_ONETIME_CHARGES . show_arrow('onetime_charges') ?>
                            </td>
<?php 
            }
            if ($display_tax === true) {
...
?>
                            <td class="lineItemHeadingContent text-right">
                                <?= TABLE_HEADING_PRODUCT_TOTAL . show_arrow('grand') ?>
                            </td>
                        </tr>
<?php
...
?>
                            ...
                            <td class="lineItemContent text-right">
                                <?= $currencies->format($p_data['base_price']) ?>
                            </td>
                            <td class="lineItemContent text-right">
                                <?= $currencies->format($p_data['final_price']) ?>
                            </td>
                            <td class="lineItemContent text-right">
                                <?= $p_data['quantity'] ?>
                            </td>
...
?>
                            <td class="lineItemContent text-right">
                                <?= $currencies->format($p_data['onetime_charges']) ?>
                            </td>
<?php 
                }
                if ($display_tax === true) {
?>
                            <td class="lineItemContent text-right">
                                <?= $currencies->format($p_data['total']) ?>
                            </td>
<?php 
                }
?>
                            <td class="lineItemContent text-right">
                                <?= $currencies->format($p_data['grand']) ?>
                            </td>
                        </tr>
<?php
...
?>
                <tr class="lineItemHeadingRow">
                    <td class="lineItemHeadingContent text-center" colspan="<?= $colspan ?>">
                        <?= MATRIX_GENERAL_STATS ?>
                    </td>
                </tr>
                <tr class="lineItemRow">
                    <td colspan="<?= $colspan ?>"><table>
                        <tr class="lineItemRow v-top">
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="3">
                                        <strong><?= MATRIX_ORDER_REVENUE ?></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent">
                                    ...
                                    <td class="lineItemContent">
                                        <?= $timeframe['matrix']['biggest_per_revenue'] ?>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= '(' . $currencies->format($timeframe['orders'][ $timeframe['matrix']['biggest_per_revenue'] ]['goods']) . ')' ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent">
                                    ...
                                    <td class="lineItemContent">
                                        <?= $timeframe['matrix']['smallest_per_revenue'] ?>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= '(' . $currencies->format($timeframe['orders'][ $timeframe['matrix']['smallest_per_revenue'] ]['goods']) . ')' ?>
                                    </td>
                                </tr>
                            </table></td>
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="3">
                                        <strong><?= MATRIX_ORDER_PRODUCT_COUNT ?></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent">
                                    ...
                                    <td class="lineItemContent">
                                        <?= $timeframe['matrix']['biggest_per_product'] ?>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= '(' . $timeframe['orders'][ $timeframe['matrix']['biggest_per_product'] ]['num_products'] . ')' ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent">
                                    ...
                                    <td class="lineItemContent">
                                        <?= $timeframe['matrix']['smallest_per_product'] ?>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= '(' . $timeframe['orders'][ $timeframe['matrix']['smallest_per_product'] ]['num_products'] . ')' ?>
                                    </td>
                                </tr>
                            </table></td>
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="2">
                                        <strong><?= MATRIX_AVERAGES ?></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent text-right">
                                        <strong><?= $currencies->format($timeframe['matrix']['avg_order_value']) ?></strong>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= MATRIX_AVG_ORDER ?>
                                    </td>
                                ...
                                <tr>
                                    <td class="lineItemContent text-right">
                                        <strong><?= number_format($timeframe['matrix']['avg_products_per_order'], NUM_DECIMAL_PLACES) ?></strong>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= MATRIX_AVG_PROD_ORDER ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent text-right">
                                        <strong><?= number_format($timeframe['matrix']['avg_diff_products_per_order'], NUM_DECIMAL_PLACES) ?></strong>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= MATRIX_AVG_PROD_ORDER_DIFF ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="lineItemContent text-right">
                                        <strong><?= number_format($timeframe['matrix']['avg_orders_per_customer'], NUM_DECIMAL_PLACES) ?></strong>
                                    </td>
                                    <td class="lineItemContent">
                                        <?= MATRIX_AVG_ORDER_CUST ?>
                                    </td>
                                </tr>
                            </table></td>
                        </tr>
                    ...
                    <td colspan="<?= $colspan ?>"><table>
                        <tr class="lineItemRow v-top">
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="3">
                                        <strong><?= MATRIX_TOTAL_PAYMENTS ?></strong>
                                    </td>
                                </tr>
<?php 
...
?>
                            ...
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="3">
                                        <strong><?= MATRIX_TOTAL_SHIPPING ?></strong>
                                    </td>
                                </tr>
<?php 
...
?>
                            <td><table class="table">
                                <tr>
                                    <td class="lineItemContent" colspan="2">
                                        <strong><?= MATRIX_TOTAL_CURRENCIES ?></strong>
                                    </td>
                                </tr>
<?php 
...
?>
                ...
                <tr class="lineItemRow">
                    <td colspan="<?= $colspan ?>"><table class="table">
                        <tr class="lineItemRow">
                            <td class="lineItemContent">
                                <strong><?= TABLE_HEADING_PRODUCT_ID ?></strong>
                            </td>
                            <td class="lineItemContent">
                                <strong><?= TABLE_HEADING_PRODUCT_NAME ?></strong>
                            </td>
                            <td class="lineItemContent text-center">
                                <strong><?= MATRIX_PRODUCT_SPREAD ?></strong>
                            </td>
                            <td class="lineItemContent text-right">
                                <strong><?= MATRIX_PRODUCT_REVENUE_RATIO ?></strong>
                            </td>
                            <td class="lineItemContent text-right">
                                <strong><?= MATRIX_PRODUCT_QUANTITY_RATIO ?></strong>
                            </td>
                        </tr>
<?php
            foreach ($timeframe['products'] as $pID => $p_data) {
?>
                        <tr class="lineItemRow">
                            ...
                            <td class="lineItemContent">
                                <?= $p_data['name'] . $p_data['attributes'] ?>
                            </td>
                            <td class="lineItemContent text-center">
                                <?= $timeframe['matrix']['product_spread'][$pID] ?>
                            </td>
                            <td class="lineItemContent text-right">
                                <?= $timeframe['matrix']['product_revenue_ratio'][$pID] ?>
                            </td>
                            <td class="lineItemContent text-right">
                                <?= $timeframe['matrix']['product_quantity_ratio'][$pID] ?>
                            </td>
                        </tr>
<?php
            }
...
?>
                    <td class="totalHeadingContent text-right">
                        <?= TABLE_HEADING_SHIPPING ?>
                    </td>
                    <td class="totalHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_DISCOUNTS ?>
                    </td>
                    <td class="totalHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_GC_SOLD ?>
                    </td>
                    <td class="totalHeadingContent text-center" colspan="2">
                        <?= TABLE_HEADING_GC_USED ?>
                    </td>
                    <td class="totalHeadingContent text-right">
                        <?= TABLE_HEADING_TOTAL ?>
                    </td>
      ...
      <!-- GRAND TOTAL LINE -->
                <tr class="footerRow">
                    <td class="footerContent">
                        <?= count($sr->timeframe) . TABLE_FOOTER_TIMEFRAMES ?>
                    </td>
                    <td class="footerContent">
                        <?= $sr->grand_total['num_orders'] ?>
                    </td>
                    <td class="footerContent text-center" colspan="2">
                        <?= $sr->grand_total['num_products'] ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['goods']) ?>
                    </td>
<?php 
        if ($display_tax === true) {
?>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['goods_tax']) ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['order_recorded_tax']) ?>
                    </td>
<?php 
        }
?>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['shipping']) ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['discount']) ?>
                    </td>
                    <td class="footerContent no-wrap">
                        <?= TEXT_QTY . $sr->grand_total['discount_qty'] ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['gc_sold']) ?>
                    </td>
                    <td class="footerContent no-wrap">
                        <?= TEXT_QTY . $sr->grand_total['gc_sold_qty'] ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['gc_used']) ?>
                    </td>
                    <td class="footerContent no-wrap">
                        <?= TEXT_QTY . $sr->grand_total['gc_used_qty'] ?>
                    </td>
                    <td class="footerContent text-right">
                        <?= $currencies->format($sr->grand_total['grand']) ?>
                    </td>
<?php 
        if ($sr->detail_level === 'order' && $order_total_validation === true) {
?>
...
?>
        <tr>
            <td><?= zen_draw_separator('pixel_trans.gif', 30, 20) ?></td>
            <td class="smallText text-right">
                <?= TEXT_REPORT_TIMESTAMP . zen_datetime_short(date('Y-m-d H:i:s')) ?>
            </td>
        </tr>
<?php
...
?>
        <tr>
            <td colspan="2" class="text-right">
                <a href="<?= zen_href_link(FILENAME_STATS_SALES_REPORT2, zen_get_all_get_params(['output_format', 'auto_print']) . 'output_format=print&auto_print=1', 'NONSSL') ?>" title="<?= TEXT_PRINT_FORMAT_TITLE ?>">
                    <span class="smallText"><i class="fa fa-2x fa-print" aria-hidden="true"></i><?= TEXT_PRINT_FORMAT ?></span>
                </a>
            </td>
        </tr>
        <tr>
            ...
            <td><?= zen_draw_separator('pixel_trans.gif', 1, 20) ?></td>
        </tr>
<?php
    }
...
function show_arrow($report_field)
{
    ...
    $down_arrow = sales_report2::getDownArrowIcon();
    $up_arrow = sales_report2::getUpArrowIcon();
    ...
    if (isset($sort_order)) {
        ...
        if ($output_format === 'display') {
            $link = '<a href="' . zen_href_link(FILENAME_STATS_SALES_REPORT2, $link_parms, 'NONSSL') . '">';
